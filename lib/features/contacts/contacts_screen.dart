        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => const AddByPhoneScreen(),
            )),
          ),
        ],
      ),
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, i) {
                          final c = _filtered[i];
                          return ListTile(
                            leading: GBAvatar(url: c.avatarUrl, name: c.name, size: 48),
                            title: Text(c.name, style: const TextStyle(fontWeight: FontWeight.w500)),
                            subtitle: Text(c.phone, style: TextStyle(
                                color: theme.theme.textHint, fontSize: 13)),
                            trailing: c.registered
                                ? TextButton(
                                    onPressed: () => _openChat(c),
                                    child: const Text('РќР°РїРёСЃР°С‚СЊ'),
                                  )
                                : const Icon(Icons.person_add, color: GBTheme.textSecondary),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('РќРµС‚ РєРѕРЅС‚Р°РєС‚РѕРІ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
          const SizedBox(height: 8),
          const Text('РЎРёРЅС…СЂРѕРЅРёР·РёСЂСѓР№С‚Рµ РєРѕРЅС‚Р°РєС‚С‹ РёР· С‚РµР»РµС„РѕРЅР°',
